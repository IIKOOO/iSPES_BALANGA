...
@peso_bp.route('/download_student_registration_csv')
...
@peso_bp.route('/download_pending_student_registration_csv')
...
@peso_bp.route('/download_final_spes_list_csv')
...
@peso_bp.route('/download_student_dtr_records_csv')
...
@peso_bp.route('/download_student_payroll_csv')
...
def update_total_worked_hours_for_student(student_id):
    with conn.cursor() as cur:
        cur.execute("""
